...
public class Silly implements Comparable<Silly>{
     ...
     * Creates a new Silly object.
     * This constructor takes in two Strings as an argument, and sets the attribute name to be the concatenation of the
     * two.
     *
     * @param first the first half of the name for this Silly instance
     * @param last the second half of the name for this Silly instance
     */
